...
# ---------------------------------------------------------------------------
# Original SVG skyline -- a generic silhouette built from the shared visual
# vocabulary of European academic architecture (twin-spired hall, a domed
# rotunda, a clock/bell tower, a colonnaded neoclassical facade, a modern
# glass block) so the hero reads as "European university" without using a
# hotlinked or stock photograph.
# ---------------------------------------------------------------------------
EUROPEAN_SKYLINE_SVG = """
<svg viewBox="0 0 1600 320" preserveAspectRatio="xMidYMax slice" xmlns="http://www.w3.org/2000/svg">
  <defs>
    <linearGradient id="skylineGrad" x1="0" y1="0" x2="0" y2="1">
      <stop offset="0%" stop-color="#3B82F6" stop-opacity="0.5"/>
      <stop offset="100%" stop-color="#081226" stop-opacity="0.92"/>
    </linearGradient>
  </defs>

  <!-- modern glass block (far left, low) -->
  <g class="bld">
    <rect x="0" y="220" width="150" height="100" />
    <g class="window lit"><rect x="16" y="236" width="10" height="14"/><rect x="40" y="236" width="10" height="14"/><rect x="64" y="236" width="10" height="14"/><rect x="88" y="236" width="10" height="14"/><rect x="112" y="236" width="10" height="14"/></g>
    <g class="window"><rect x="16" y="262" width="10" height="14"/><rect x="40" y="262" width="10" height="14"/><rect x="64" y="262" width="10" height="14"/><rect x="88" y="262" width="10" height="14"/><rect x="112" y="262" width="10" height="14"/></g>
    <g class="window lit"><rect x="16" y="288" width="10" height="14"/><rect x="40" y="288" width="10" height="14"/><rect x="64" y="288" width="10" height="14"/><rect x="88" y="288" width="10" height="14"/><rect x="112" y="288" width="10" height="14"/></g>
  </g>

  <!-- gothic twin-spire hall -->
  <g class="bld">
    <rect x="170" y="190" width="230" height="130" />
    <rect x="196" y="96" width="46" height="94" />
    <polygon points="196,96 219,34 242,96" />
    <rect x="322" y="70" width="46" height="120" />
    <polygon points="322,70 345,0 368,70" />
    <circle class="window lit" cx="285" cy="240" r="13" />
    <rect class="window" x="200" y="220" width="10" height="26"/>
    <rect class="window lit" x="376" y="220" width="10" height="26"/>
    <rect class="window" x="356" y="220" width="10" height="26"/>
  </g>

  <!-- domed rotunda -->
  <g class="bld">
    <rect x="430" y="230" width="180" height="90" />
    <rect x="452" y="200" width="12" height="30"/><rect x="478" y="200" width="12" height="30"/>
    <rect x="504" y="200" width="12" height="30"/><rect x="530" y="200" width="12" height="30"/><rect x="556" y="200" width="12" height="30"/>
    <path d="M 442 200 A 78 78 0 0 1 598 200 Z" />
    <rect x="514" y="150" width="12" height="30" />
    <circle class="window lit" cx="520" cy="146" r="6"/>
  </g>

  <!-- clock / bell tower -->
  <g class="bld">
    <rect x="640" y="120" width="70" height="200" />
    <polygon points="632,120 675,60 718,120" />
    <circle cx="675" cy="168" r="22" fill="none" class="bld-line" />
    <circle class="window lit" cx="675" cy="168" r="5" />
    <rect class="window" x="658" y="220" width="12" height="20"/>
    <rect class="window lit" x="682" y="220" width="12" height="20"/>
    <rect class="window" x="658" y="260" width="12" height="20"/>
    <rect class="window" x="682" y="260" width="12" height="20"/>
  </g>

  <!-- neoclassical colonnade -->
  <g class="bld">
    <rect x="734" y="230" width="320" height="90" />
    <polygon points="734,230 894,168 1054,230" />
    <rect x="754" y="240" width="14" height="80"/><rect x="790" y="240" width="14" height="80"/>
    <rect x="826" y="240" width="14" height="80"/><rect x="862" y="240" width="14" height="80"/>
    <rect x="898" y="240" width="14" height="80"/><rect x="934" y="240" width="14" height="80"/>
    <rect x="970" y="240" width="14" height="80"/><rect x="1006" y="240" width="14" height="80"/>
    <circle class="window lit" cx="894" cy="204" r="7"/>
  </g>

  <!-- small secondary spire -->
  <g class="bld">
    <rect x="1090" y="200" width="60" height="120" />
    <polygon points="1090,200 1120,150 1150,200" />
    <rect class="window lit" x="1108" y="230" width="10" height="18"/>
    <rect class="window" x="1108" y="262" width="10" height="18"/>
  </g>

  <!-- second glass block (far right, taller for rhythm) -->
  <g class="bld">
    <rect x="1180" y="150" width="200" height="170" />
    <g class="window">
      <rect x="1198" y="168" width="12" height="16"/><rect x="1224" y="168" width="12" height="16"/><rect x="1250" y="168" width="12" height="16"/><rect x="1276" y="168" width="12" height="16"/><rect x="1302" y="168" width="12" height="16"/><rect x="1328" y="168" width="12" height="16"/><rect x="1354" y="168" width="12" height="16"/>
    </g>
    <g class="window lit">
      <rect x="1198" y="196" width="12" height="16"/><rect x="1224" y="196" width="12" height="16"/><rect x="1250" y="196" width="12" height="16"/><rect x="1276" y="196" width="12" height="16"/><rect x="1302" y="196" width="12" height="16"/><rect x="1328" y="196" width="12" height="16"/><rect x="1354" y="196" width="12" height="16"/>
    </g>
    <g class="window">
      <rect x="1198" y="224" width="12" height="16"/><rect x="1224" y="224" width="12" height="16"/><rect x="1250" y="224" width="12" height="16"/><rect x="1276" y="224" width="12" height="16"/><rect x="1302" y="224" width="12" height="16"/><rect x="1328" y="224" width="12" height="16"/><rect x="1354" y="224" width="12" height="16"/>
    </g>
    <g class="window lit">
      <rect x="1198" y="252" width="12" height="16"/><rect x="1224" y="252" width="12" height="16"/><rect x="1250" y="252" width="12" height="16"/><rect x="1276" y="252" width="12" height="16"/><rect x="1302" y="252" width="12" height="16"/><rect x="1328" y="252" width="12" height="16"/><rect x="1354" y="252" width="12" height="16"/>
    </g>
    <g class="window">
      <rect x="1198" y="280" width="12" height="16"/><rect x="1224" y="280" width="12" height="16"/><rect x="1250" y="280" width="12" height="16"/><rect x="1276" y="280" width="12" height="16"/><rect x="1302" y="280" width="12" height="16"/><rect x="1328" y="280" width="12" height="16"/><rect x="1354" y="280" width="12" height="16"/>
    </g>
  </g>

  <!-- low connecting wall to unify the skyline baseline -->
  <rect class="bld" x="0" y="300" width="1600" height="20" opacity="0.9" />

  <!-- far-right small block to fill remaining width -->
  <g class="bld"><rect x="1400" y="250" width="200" height="70" /></g>
</svg>
"""
...
def inject_css():
    st.markdown(
        ...
        /* ---------- European university skyline silhouette ---------- */
        .skyline{
            position:absolute; left:0; right:0; bottom:0; height:38%; z-index:1;
            opacity:0.9; filter:drop-shadow(0 0 26px rgba(59,130,246,0.35));
            pointer-events:none;
        }
        .skyline svg{ width:100%; height:100%; display:block; }
        .skyline .bld{ fill:url(#skylineGrad); }
        .skyline .bld-line{ stroke:rgba(160,200,255,0.35); stroke-width:1.5; fill:none; }
        .skyline .window{ fill:rgba(180,215,255,0.55); }
        .skyline .window.lit{ fill:var(--cyan); opacity:0.9; }

        .hero-sweep{
            position:absolute; top:0; bottom:0; left:-30%; width:35%; z-index:2; pointer-events:none;
            background:linear-gradient(100deg, transparent, rgba(255,255,255,0.05) 45%, rgba(34,211,238,0.10) 50%, rgba(255,255,255,0.05) 55%, transparent);
        ...
        @media (max-width:768px){
            ...
            .skyline{ height:26%; opacity:0.7; }
        }

        @media (prefers-reduced-motion: reduce){
            .node, .hero-title, .hero-sub, .eyebrow, .stat-strip, .uni-card, .hero-sweep{ animation:none !important; opacity:1 !important; }
...
def render_hero(total_unis, total_countries, total_fields, ranked_count):
    ...
    st.markdown(
        ...
        <div class="hero">
            ...
            <div class="skyline">{EUROPEAN_SKYLINE_SVG}</div>
...
tuition_choice = st.sidebar.selectbox(
    ...
    options=["No limit", 0, 500, 1000, 1500, 2000, 2500, 3000, 3500, 4000,
              4500, 5000, 6000, 7000, 8000, 10000, 15000, 20000, 30000],
    index=0,
    help="Choose 0 for free-tuition-only. Steps are finer at the low end, where most tuition fees in the dataset actually fall.",
)
...
ranking_choice = st.sidebar.selectbox(
    ...
    options=["No limit", 50, 100, 200, 300, 500, 750, 1000, 1201],
    index=0,
    help="Universities without a QS rank are excluded if you set a limit here. "
         "QS ranks start at 1, so there's no '0' tier -- 50 is the finest cutoff, "
         "and 1201 covers every ranked university in the dataset.",
)
